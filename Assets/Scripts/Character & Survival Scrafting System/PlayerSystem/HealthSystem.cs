...
namespace LPSurvivalEngine
{
    public class HealthSystem : MonoBehaviour, IDamagable
    {
        ...
        private void Awake()
        {
            ...
            GameObject vitalBars = UIPlayer.transform.Find("UI/Vitals/VitalBars").gameObject;
            health.VitalBar = vitalBars.transform.Find("Health").GetComponent<Image>();
            hunger.VitalBar = vitalBars.transform.Find("Hunger").GetComponent<Image>();
            thirst.VitalBar = vitalBars.transform.Find("Thirst").GetComponent<Image>();
            sleep.VitalBar = vitalBars.transform.Find("Sleep").GetComponent<Image>();
