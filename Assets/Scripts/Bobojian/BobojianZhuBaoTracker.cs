...
public class BobojianZhuBaoTracker : MonoBehaviour
{
    ...
    private float liveCameraUpdateInterval = 1f;
    private float liveCameraUpdateTimer = 0f;
    ...
    private void FixedUpdate()
    {
        ...
        liveCameraUpdateTimer += Time.fixedDeltaTime;

        if (liveCameraUpdateTimer >= liveCameraUpdateInterval)
        {
