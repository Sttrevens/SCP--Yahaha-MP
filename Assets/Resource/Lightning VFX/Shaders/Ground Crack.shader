...
Shader "Mirza Beig/Lightning VFX/Ground Crack"
{
	Properties
	{
		...
		[ASEBegin][HDR]_Colour("Colour", Color) = (1,1,1,1)
		...
		[ASEEnd]_NoisePower("Noise Power", Range( 0.1 , 10)) = 1
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 Albedo18 = ( _Colour * IN.ase_color );
				
				float2 uv_Albedo = IN.ase_texcoord3.xy * _Albedo_ST.xy + _Albedo_ST.zw;
				float4 tex2DNode1 = tex2D( _Albedo, uv_Albedo );
				float2 texCoord25 = IN.ase_texcoord3.xy * float2( 2,2 ) + float2( -1,-1 );
				float RadialMask27 = saturate( ( 1.0 - length( texCoord25 ) ) );
				...
				#endif
				float ParticleAlphaErosionOverLifetime11 = IN.ase_texcoord3.z;
				float Alpha8 = saturate( ( staticSwitch42 - ( _AlphaErosionOffset + ParticleAlphaErosionOverLifetime11 ) ) );
				float ParticleStableRandomX58 = IN.ase_texcoord3.w;
				float2 temp_cast_1 = (( ParticleStableRandomX58 * 10.0 )).xx;
				float2 texCoord44 = IN.ase_texcoord3.xy * _NoiseTiling + temp_cast_1;
				float simpleNoise43 = SimpleNoise( texCoord44*_NoiseScale );
				...
				float3 Color = Albedo18.rgb;
				float Alpha = ( (Albedo18).a * Alpha8 * Noise49 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode1 = tex2D( _Albedo, uv_Albedo );
				float2 texCoord25 = IN.ase_texcoord2.xy * float2( 2,2 ) + float2( -1,-1 );
				float RadialMask27 = saturate( ( 1.0 - length( texCoord25 ) ) );
				float temp_output_37_0 = pow( RadialMask27 , _RadialMaskPower );
				#ifdef _SUBTRACTIVERADIALMASK_ON
				float staticSwitch42 = saturate( ( tex2DNode1.a - ( 1.0 - temp_output_37_0 ) ) );
				...
				float staticSwitch42 = saturate( ( tex2DNode1.a * temp_output_37_0 ) );
				#endif
				float ParticleAlphaErosionOverLifetime11 = IN.ase_texcoord2.z;
				float Alpha8 = saturate( ( staticSwitch42 - ( _AlphaErosionOffset + ParticleAlphaErosionOverLifetime11 ) ) );
				float ParticleStableRandomX58 = IN.ase_texcoord2.w;
				float2 temp_cast_0 = (( ParticleStableRandomX58 * 10.0 )).xx;
				float2 texCoord44 = IN.ase_texcoord2.xy * _NoiseTiling + temp_cast_0;
				float simpleNoise43 = SimpleNoise( texCoord44*_NoiseScale );
				float smoothstepResult46 = smoothstep( _NoiseRemapMin , _NoiseRemapMax , simpleNoise43);
				float lerpResult56 = lerp( 1.0 , pow( smoothstepResult46 , _NoisePower ) , _Noise);
				float Noise49 = lerpResult56;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 tex2DNode1 = tex2D( _Albedo, uv_Albedo );
				float2 texCoord25 = IN.ase_texcoord.xy * float2( 2,2 ) + float2( -1,-1 );
				float RadialMask27 = saturate( ( 1.0 - length( texCoord25 ) ) );
				float temp_output_37_0 = pow( RadialMask27 , _RadialMaskPower );
				#ifdef _SUBTRACTIVERADIALMASK_ON
				float staticSwitch42 = saturate( ( tex2DNode1.a - ( 1.0 - temp_output_37_0 ) ) );
				...
				float staticSwitch42 = saturate( ( tex2DNode1.a * temp_output_37_0 ) );
				#endif
				float ParticleAlphaErosionOverLifetime11 = IN.ase_texcoord.z;
				float Alpha8 = saturate( ( staticSwitch42 - ( _AlphaErosionOffset + ParticleAlphaErosionOverLifetime11 ) ) );
				float ParticleStableRandomX58 = IN.ase_texcoord.w;
				float2 temp_cast_0 = (( ParticleStableRandomX58 * 10.0 )).xx;
				float2 texCoord44 = IN.ase_texcoord.xy * _NoiseTiling + temp_cast_0;
				float simpleNoise43 = SimpleNoise( texCoord44*_NoiseScale );
				float smoothstepResult46 = smoothstep( _NoiseRemapMin , _NoiseRemapMax , simpleNoise43);
				float lerpResult56 = lerp( 1.0 , pow( smoothstepResult46 , _NoisePower ) , _Noise);
				float Noise49 = lerpResult56;
				...
				surfaceDescription.Alpha = ( (Albedo18).a * Alpha8 * Noise49 );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float4 tex2DNode1 = tex2D( _Albedo, uv_Albedo );
				float2 texCoord25 = IN.ase_texcoord1.xy * float2( 2,2 ) + float2( -1,-1 );
				float RadialMask27 = saturate( ( 1.0 - length( texCoord25 ) ) );
				float temp_output_37_0 = pow( RadialMask27 , _RadialMaskPower );
				#ifdef _SUBTRACTIVERADIALMASK_ON
				float staticSwitch42 = saturate( ( tex2DNode1.a - ( 1.0 - temp_output_37_0 ) ) );
				...
				float staticSwitch42 = saturate( ( tex2DNode1.a * temp_output_37_0 ) );
				#endif
				float ParticleAlphaErosionOverLifetime11 = IN.ase_texcoord1.z;
				float Alpha8 = saturate( ( staticSwitch42 - ( _AlphaErosionOffset + ParticleAlphaErosionOverLifetime11 ) ) );
				float ParticleStableRandomX58 = IN.ase_texcoord1.w;
				float2 temp_cast_0 = (( ParticleStableRandomX58 * 10.0 )).xx;
				float2 texCoord44 = IN.ase_texcoord1.xy * _NoiseTiling + temp_cast_0;
				float simpleNoise43 = SimpleNoise( texCoord44*_NoiseScale );
				float smoothstepResult46 = smoothstep( _NoiseRemapMin , _NoiseRemapMax , simpleNoise43);
				float lerpResult56 = lerp( 1.0 , pow( smoothstepResult46 , _NoisePower ) , _Noise);
				float Noise49 = lerpResult56;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;63;463.9981,19.10884;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;64;463.9981,19.10884;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Mirza Beig/Lightning VFX/Ground Crack;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;2;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638266802476710536;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;0;638267961664170492;  Use Shadow Threshold;1;638267961057599905;Receive Shadows;0;638267963634507245;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;65;463.9981,19.10884;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;66;463.9981,19.10884;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;67;463.9981,19.10884;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;68;463.9981,19.10884;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;69;463.9981,19.10884;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;SceneSelectionPass;0;6;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;70;463.9981,19.10884;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;ScenePickingPass;0;7;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;71;463.9981,19.10884;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;DepthNormals;0;8;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormalsOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;72;463.9981,19.10884;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;DepthNormalsOnly;0;9;DepthNormalsOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormalsOnly;False;True;9;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;ps5;switch;0;;0;0;Standard;0;False;0
...
WireConnection;64;3;32;0
ASEEND*/
//CHKSM=BD123D425C5C72AE085E3069C507F3742D0E2AF3